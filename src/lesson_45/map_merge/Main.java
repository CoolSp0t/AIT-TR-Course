...
public class Main {
    ...
    value - значение, связанное с ключом в key
    remapping function - третий параметр будет использован если ключ key уже существует

    Метод просто добавляет значение value по ключу key если такого ключа в мапе еще нет.
    а если есть , то в третьем параметре( remapping function ) определяется какое будет новое значение value
     */
