...
//        a = 10;
        ...
        int [] numbers3;
        numbers3 = new int[] {1, 5, -16, 25, 0};
//        numbers3 = {1,5,-16,25,0} illegal
        ...
        String string = "Two";
        int strCounter = 0;
        while (strCounter < string.length()){
        ...
        int[] arraySubarray4 = Arrays.copyOfRange(myArray2, 4 , 100); // [ 17, 56, 101, 0, 145, 0, 0, 0 .... 0] -> new int[100-4]
        ...
        System.out.println(Arrays.equals(arraySubarray2, arraySubarray2));
        System.out.println("My array2" + Arrays.toString(myArray2) );
